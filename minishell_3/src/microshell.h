...
/*   Updated: 2024/03/20 21:04:04 by aismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_command
{
	...
	bool			detected_amb;
	bool			expanded_cmd;//
	bool			*expanded_args;//must adjust in default command
	bool			is_built_in;
	bool			end_of_cmd;
}	t_command;
...
//ft_split_sec.c
char	**ft_split_sec(char *s, char *delimeter);
...
char	*file_error_handline2(t_shell *shell, int i, char *path_env);
